...
import { Editable, EditableImg } from '@coreshift/live-edit';
          ...
          <div>
            <AnimateIn>
              <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-2 mb-6">
                ...
                <Editable as="span" path="hero.badge" className="text-blue-200 text-sm font-medium">Trusted by 100+ Australian law firms</Editable>
              </div>
            </AnimateIn>

            <AnimateIn delay={0.1}>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                <Editable as="span" path="hero.titleLead">Bringing clarity to property contracts —</Editable>{' '}
                <Editable as="span" path="hero.titleAccent" className="text-blue-300">for everyone involved</Editable>
              </h1>
            </AnimateIn>

            <AnimateIn delay={0.2}>
              <Editable as="p" path="hero.subtitle" className="text-lg text-blue-200/80 max-w-xl mb-8 leading-relaxed">
            ...
            <AnimateIn delay={0.3}>
              <div className="flex flex-wrap gap-4">
                <a href="#contact" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold px-7 py-3.5 rounded-xl transition-all hover:shadow-lg hover:shadow-blue-600/25">
                  <Editable as="span" path="hero.ctaPrimary">Book a Demo</Editable> <ArrowRight size={18} />
                </a>
                <a href="#download" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/15 text-white font-semibold px-7 py-3.5 rounded-xl border border-white/20 transition-all">
                  <Download size={18} /> <Editable as="span" path="hero.ctaSecondary">Download App</Editable>
                </a>
              </div>
            </AnimateIn>
          </div>
          ...
          <AnimateIn delay={0.3} direction="right">
            <div className="relative flex justify-center items-center">
              ...
              <div className="hidden lg:block absolute -top-8 -right-4 w-[420px] rounded-xl shadow-2xl overflow-hidden border border-white/10 opacity-60">
                <EditableImg path="hero.images.0" src="/images/dd147336-f23e-4d9b-aa00-6a4cdf34fa63.webp" alt="EzyConvey web dashboard" className="w-full" />
              </div>
              {/* Main phone */}
              <div className="relative z-10 w-[280px] sm:w-[300px]">
                <EditableImg path="hero.images.1" src="/images/d2ce347e-7cdc-40e8-9804-b2a02d380a40.webp" alt="EzyConvey mobile app — agent dashboard" className="w-full rounded-3xl shadow-2xl" />
              </div>
              {/* Second phone offset */}
              <div className="hidden sm:block absolute -bottom-8 -left-8 w-[220px] z-20">
                <EditableImg path="hero.images.2" src="/images/fc03671c-50c3-4057-aa3d-6837c0be2d2f.webp" alt="EzyConvey mobile — case details" className="w-full rounded-3xl shadow-xl border-2 border-white/10" />
              </div>
            </div>
          </AnimateIn>
        </div>
